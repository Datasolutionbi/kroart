                ...
                >
                    <h3 className="artence-title !text-4xl lg:!text-6xl text-white max-w-5xl mx-auto leading-tight flex flex-wrap justify-center gap-x-6">
                        {typeof window !== 'undefined' && window.innerWidth < 768 ? (
                            ...
                            >
                                Digital Art is the new <span className="italic text-accent-emerald">Renaissance</span> of Human Error.
                            </motion.span>
                        ) : (
                            // Desktop: Precise character reveal
                            <>
